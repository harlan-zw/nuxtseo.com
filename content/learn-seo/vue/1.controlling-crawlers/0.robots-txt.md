...
description: Learn why, when and how to implement a best practice robots.txt in your Vue apps.
navigation:
  title: 'Robots.txt'
...
The `robots.txt` file lives in your root web directory is a common way to [control how crawlers access your site](/learn-seo/vue/controlling-crawlers).
...
Implementing `robots.txt` is straightforward, you can either create a static file or a dynamic one for Vue applications.
...
- Not all crawlers follow the rules - see our [security guide](/learn-seo/vue/controlling-crawlers/security)

### SEO Impact

- Blocking search crawlers prevents indexing but doesn't remove existing pages
- For page-level control, use [meta robots tags](/learn-seo/vue/controlling-crawlers/meta-tags) instead
...
Disallow: /
```
See our [security guide](/learn-seo/vue/controlling-crawlers/security) for more on environment protection.
...
- [Meta Robots Guide](/learn-seo/vue/controlling-crawlers/meta-tags) - Page-level crawler control
- [Sitemaps Guide](/learn-seo/vue/controlling-crawlers/sitemaps) - Telling crawlers about your pages
- [Security Guide](/learn-seo/vue/controlling-crawlers/security) - Protecting from malicious crawlers
