---
title: Canonical Link Tag in Vue
...
- Paginated content
- [HTTP/HTTPS duplicates](/learn-seo/vue/controlling-crawlers/security#http-https)

**❌ Don't use for:**

- Entirely different content
- Redirecting users (use [HTTP redirects](/learn-seo/vue/controlling-crawlers/redirects) instead)
- Blocked pages (use [meta robots](/learn-seo/vue/controlling-crawlers/meta-tags) with noindex)
...
- Combining with [meta robots](/learn-seo/vue/controlling-crawlers/meta-tags) can send mixed signals
- Consider alongside your [sitemap strategy](/learn-seo/vue/controlling-crawlers/sitemaps)
- Check interaction with [crawler directives](/learn-seo/vue/controlling-crawlers)
...
- Check for conflicting [meta robots directives](/learn-seo/vue/controlling-crawlers/meta-tags)
...
### Core Concepts
- [Understanding Crawler Control](/learn-seo/vue/controlling-crawlers) - How crawlers work
- [Security Best Practices](/learn-seo/vue/controlling-crawlers/security) - Secure implementation

### Implementation Methods
- [Meta Robots Guide](/learn-seo/vue/controlling-crawlers/meta-tags) - Page-level crawler directives
- [HTTP Redirects](/learn-seo/vue/controlling-crawlers/redirects) - URL migration strategies
- [Robots.txt Usage](/learn-seo/vue/controlling-crawlers/robots-txt) - Site-wide crawler rules

### Additional Resources
- [Google's Canonical Guidelines](https://developers.google.com/search/docs/crawling-indexing/consolidate-duplicate-urls)
- [Sitemap Integration](/learn-seo/vue/controlling-crawlers/sitemaps) - URL discovery optimization
