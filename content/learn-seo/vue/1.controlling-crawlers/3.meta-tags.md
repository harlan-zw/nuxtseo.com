...
Meta robots tags control how search engines handle individual pages. While [robots.txt provides site-wide rules](/learn-seo/vue/controlling-crawlers/robots-txt), meta robots tags are crucial for precise page-level control over indexing and crawling behavior.
...
- [Protecting sensitive sections](/learn-seo/vue/controlling-crawlers/security) when combined with authentication
...
- Site-wide rules (use [robots.txt](/learn-seo/vue/controlling-crawlers/robots-txt) instead)
- Blocking specific crawlers (use [robots.txt](/learn-seo/vue/controlling-crawlers/robots-txt) instead)
- URL management (use [canonical URLs](/learn-seo/vue/controlling-crawlers/canonical-urls) or [redirects](/learn-seo/vue/controlling-crawlers/redirects) instead)
...
- Must be [server-side rendered](/learn-seo/vue/controlling-crawlers/security#ensuring-ssr) for crawler effectiveness
...
- Consider combining with [canonical URLs](/learn-seo/vue/controlling-crawlers/canonical-urls) for duplicate content
...
useSeoMeta({
  robots: 'noindex, follow',
  // Learn more about canonical URLs at /learn-seo/vue/controlling-crawlers/canonical-urls
...
See [handling pagination in Vue](/learn-seo/vue/controlling-crawlers/sitemaps#pagination) for more comprehensive pagination strategies.
...
For permanent content changes, consider using [HTTP redirects](/learn-seo/vue/controlling-crawlers/redirects) instead.
...
For sensitive user content, review our [security guide](/learn-seo/vue/controlling-crawlers/security#user-generated-content).
...
- Confirm SSR implementation ([why this matters](/learn-seo/vue/controlling-crawlers/security#ensuring-ssr))
- Verify placement in `<head>`
- Check directives syntax
- Test across different page types
- Monitor indexing status changes
- Verify interaction with [other crawler controls](/learn-seo/vue/controlling-crawlers)

## Related

### Core Concepts
- [Understanding Web Crawlers](/learn-seo/vue/controlling-crawlers) - Complete guide to crawler control
- [Securing Your Site From Crawlers](/learn-seo/vue/controlling-crawlers/security) - Protect sensitive content

### Implementation Methods
- [Robots.txt Guide](/learn-seo/vue/controlling-crawlers/robots-txt) - Site-wide crawler rules
- [Canonical URLs](/learn-seo/vue/controlling-crawlers/canonical-urls) - Managing duplicate content
- [HTTP Redirects](/learn-seo/vue/controlling-crawlers/redirects) - Page relocation best practices

### Additional Resources
- [Sitemap Implementation](/learn-seo/vue/controlling-crawlers/sitemaps) - Help crawlers discover your content
...
[Learn more about meta robots tags in Nuxt →](/learn-seo/nuxt/controlling-crawlers/meta-tags)
