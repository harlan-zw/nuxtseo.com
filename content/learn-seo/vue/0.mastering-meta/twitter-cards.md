...
useSeoMeta({
  twitterCard: 'summary_large_image',
  twitterTitle: props.post.title,
  twitterDescription: props.post.excerpt,
  twitterImage: props.post.coverImage
})
</script>
```
...
- [Open Graph Meta Tags](/learn-seo/vue/mastering-meta/open-graph) - Facebook's version of social cards
- [Meta Tag Priorities](/learn-seo/vue/mastering-meta/priorities) - Which tags override others
- [Image Optimization](/learn-seo/vue/mastering-meta/image-optimization) - Optimizing social preview images
...
[Learn more about Twitter Cards in Nuxt →](/learn-seo/nuxt/mastering-meta/twitter-cards)
