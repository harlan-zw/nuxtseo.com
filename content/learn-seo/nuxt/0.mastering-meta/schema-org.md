---
title: Schema.org in Nuxt
description: Schema.org can help search engines understand your content better, but is it worth the effort? Learn when to use it and when to skip it in Nuxt applications.
navigation:
  title: 'Schema.org'
...
In Nuxt the head manager we use is called [Unhead](https://unhead.unjs.io/).
...
As Nuxt is hierarchical, we don't need to define the `WebSite` and `WebPage` nodes in every component if they're defined in the layout.
