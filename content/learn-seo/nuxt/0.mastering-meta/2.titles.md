...
description: Learn how to master page titles in Nuxt using useHead, title templates, and SEO best practices. Includes reactive titles, social sharing, and template params.
navigation:
  title: 'Titles'
...
5. Use Nuxt SEO Utils for advanced features
...
Instead, use Nuxt's head manager [Unhead](https://unhead.unjs.io/) (already included in Nuxt).
