---
title: Robots.txt in Nuxt
description: Learn why, when and how to implement a best practice robots.txt in your Nuxt apps.
navigation:
  title: 'Robots.txt'
...
The `robots.txt` file lives in your root web directory is a common way to [control how crawlers access your site](/learn-seo/nuxt/controlling-crawlers).
...
Implementing `robots.txt` is straightforward, you can either create a static file or a dynamic one for Nuxt applications.
...
Using Nuxt? The [Nuxt Robots](/docs/robots/getting-started/introduction) module can handle this automatically.
...
- Not all crawlers follow the rules - see our [security guide](/learn-seo/nuxt/controlling-crawlers/security)

### SEO Impact

- Blocking search crawlers prevents indexing but doesn't remove existing pages
- For page-level control, use [meta robots tags](/learn-seo/nuxt/controlling-crawlers/meta-tags) instead
...
Disallow: /
```
See our [security guide](/learn-seo/nuxt/controlling-crawlers/security) for more on environment protection.
...
- [Meta Robots Guide](/learn-seo/nuxt/controlling-crawlers/meta-tags) - Page-level crawler control
- [Sitemaps Guide](/learn-seo/nuxt/controlling-crawlers/sitemaps) - Telling crawlers about your pages
- [Security Guide](/learn-seo/nuxt/controlling-crawlers/security) - Protecting from malicious crawlers
