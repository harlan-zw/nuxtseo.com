---
title: Controlling Web Crawlers in Nuxt
description: Learn how to effectively manage web crawlers in Nuxt applications to optimize SEO and protect your content.
navigation:
...
Learn more in our [meta tags guide](/learn-seo/nuxt/controlling-crawlers/meta-tags).
...
See our [canonical URLs guide](/learn-seo/nuxt/controlling-crawlers/canonical-urls) for ensuring consistent social previews.
...
Learn to manage AI crawler access in our [security guide](/learn-seo/nuxt/controlling-crawlers/security).
...
- [`robots.txt`](/learn-seo/nuxt/controlling-crawlers/robots-txt): Tells specific crawlers what they can and can't access
- [`sitemap.xml`](/learn-seo/nuxt/controlling-crawlers/sitemaps): Tells crawlers what pages are on your site
- [`<meta name="robots" content="...">`](/learn-seo/nuxt/controlling-crawlers/meta-tags): Tells search engine crawlers how to index your page
...
- [`<link rel="canonical" href="...">`](/learn-seo/nuxt/controlling-crawlers/canonical-urls): Tells search engine crawlers which URL is the preferred version of a page
- [HTTP Redirects](/learn-seo/nuxt/controlling-crawlers/redirects): Redirect bots and keep your page SEO benefits
- [Web Application Firewall](/learn-seo/nuxt/controlling-crawlers/security): At a network level, identify and block malicious bots from accessing your site

| Control Mechanism                                                                                                                                                    | Best Used When |
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|
| [`robots.txt`](/learn-seo/nuxt/controlling-crawlers/robots-txt)<br><br>[Nuxt Robots](/docs/robots/getting-started/introduction)                                               | - Blocking large sections of your site (e.g., `/admin/*`)<br>- Managing crawler bandwidth on heavy pages<br>- Preventing crawling of development assets |
| [`<meta name="robots">`](/learn-seo/nuxt/controlling-crawlers/meta-tags)<br><br>[Nuxt Robots](/docs/robots/getting-started/introduction)                                         | - Controlling indexing for individual pages<br>- Managing dynamic content (search results, filtered pages)<br>- Setting page-specific crawler directives |
| [`sitemap.xml`](/learn-seo/nuxt/controlling-crawlers/sitemaps)<br><br>[Nuxt Sitemap](/docs/sitemap/getting-started/introduction)                                                   | - Helping crawlers discover new pages<br>- Prioritizing important pages<br>- Managing large sites with many pages |
...
| [`<link rel="canonical">`](/learn-seo/nuxt/controlling-crawlers/canonical-urls)<br><br> [Nuxt SEO Utils](/docs/seo-utils/getting-started/introduction)                            | - Managing duplicate content from URL parameters<br>- Consolidating mobile/desktop variants<br>- Handling cross-domain syndicated content |
| [HTTP Redirects](/learn-seo/nuxt/controlling-crawlers/redirects)                                                                                                              | - Moving pages permanently (301 redirects)<br>- Preserving SEO value when restructuring<br>- Managing legacy URLs |
| [Web Application Firewall](/learn-seo/nuxt/controlling-crawlers/security)                                                                                                     | - Blocking malicious bots<br>- Filtering high-volume crawler traffic<br>- Protecting against content scraping |
...
[Continue reading about implementation details ->](/learn-seo/nuxt/controlling-crawlers/robots-txt)
