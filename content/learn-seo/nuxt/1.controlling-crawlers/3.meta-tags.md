---
title: Meta Robots Tag in Nuxt
description: Learn how to effectively use meta robots tags to control crawler behavior in Nuxt applications.
navigation:
...
Meta robots tags control how search engines handle individual pages. While [robots.txt provides site-wide rules](/learn-seo/nuxt/controlling-crawlers/robots-txt), meta robots tags are crucial for precise page-level control over indexing and crawling behavior.
...
- [Protecting sensitive sections](/learn-seo/nuxt/controlling-crawlers/security) when combined with authentication
...
- Site-wide rules (use [robots.txt](/learn-seo/nuxt/controlling-crawlers/robots-txt) instead)
- Blocking specific crawlers (use [robots.txt](/learn-seo/nuxt/controlling-crawlers/robots-txt) instead)
- URL management (use [canonical URLs](/learn-seo/nuxt/controlling-crawlers/canonical-urls) or [redirects](/learn-seo/nuxt/controlling-crawlers/redirects) instead)

## Quick Setup

Add meta robots tags to your Nuxt pages using [Unhead](https://unhead.unjs.io/) composables:
...
- Must be [server-side rendered](/learn-seo/nuxt/controlling-crawlers/security#ensuring-ssr) for crawler effectiveness
...
- Consider combining with [canonical URLs](/learn-seo/nuxt/controlling-crawlers/canonical-urls) for duplicate content
...
See [handling pagination in Nuxt](/learn-seo/nuxt/controlling-crawlers/sitemaps#pagination) for more comprehensive pagination strategies.

### Temporary Content

```ts [pages/sales/[campaign].vue]
...
For permanent content changes, consider using [HTTP redirects](/learn-seo/nuxt/controlling-crawlers/redirects) instead.
...
For sensitive user content, review our [security guide](/learn-seo/nuxt/controlling-crawlers/security#user-generated-content).
...
- Confirm SSR implementation ([why this matters](/learn-seo/nuxt/controlling-crawlers/security#ensuring-ssr))
- Verify placement in `<head>`
- Check directives syntax
- Test across different page types
- Monitor indexing status changes
- Verify interaction with [other crawler controls](/learn-seo/nuxt/controlling-crawlers)

## Related

### Core Concepts
- [Understanding Web Crawlers](/learn-seo/nuxt/controlling-crawlers) - Complete guide to crawler control
- [Securing Your Site From Crawlers](/learn-seo/nuxt/controlling-crawlers/security) - Protect sensitive content

### Implementation Methods
- [Robots.txt Guide](/learn-seo/nuxt/controlling-crawlers/robots-txt) - Site-wide crawler rules
- [Canonical URLs](/learn-seo/nuxt/controlling-crawlers/canonical-urls) - Managing duplicate content
- [HTTP Redirects](/learn-seo/nuxt/controlling-crawlers/redirects) - Page relocation best practices

### Additional Resources
- [Sitemap Implementation](/learn-seo/nuxt/controlling-crawlers/sitemaps) - Help crawlers discover your content
