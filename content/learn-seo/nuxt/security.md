...
description: Learn how to protect your Nuxt application from malicious crawlers and bots.
navigation:
  title: 'Security'
...
[Robots.txt](/learn-seo/nuxt/controlling-crawlers/robots-txt) and [meta robots](/learn-seo/nuxt/controlling-crawlers/meta-tags) are polite suggestions. Malicious crawlers ignore them. You need actual security to protect sensitive content.
...
Protect your Nuxt app from unwanted crawlers:
...
### Core Concepts
- [Web Crawler Basics](/learn-seo/nuxt/controlling-crawlers) - How crawlers work
- [Robots.txt Guide](/learn-seo/nuxt/controlling-crawlers/robots-txt) - Basic crawler control
