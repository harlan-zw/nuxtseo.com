---
title: Routes and Rendering in Nuxt SEO
description: How URL structure and rendering modes affect search engine crawling, indexing, and ranking in Nuxt applications.
navigation:
...
Read the [trailing slashes guide](/learn-seo/nuxt/routes-and-rendering/trailing-slashes) for implementation details.
...
Read the [routes guide](/learn-seo/nuxt/routes-and-rendering/routes) for advanced patterns.
...
Read the [rendering modes guide](/learn-seo/nuxt/routes-and-rendering/rendering) for complete examples.
...
URLs appear in search results. Users see them before clicking. `/learn-seo/nuxt/seo-basics` tells users what the page contains. `/page?id=1523` doesn't.
...
[Continue reading about trailing slashes ->](/learn-seo/nuxt/routes-and-rendering/trailing-slashes)
